 ...
 {	 
  ...
  NVIC_PriorityGroupConfig(NVIC_PriorityGroup_2);//设置中断优先级分组为组2：2位抢占优先级，2位响应优先级
	...
	{	    
 	...
 	Show_Str(30,50,200,16,"精英 STM32开发板",16,0);	 		    	 
	Show_Str(30,70,200,16,"WAV录音机实验",16,0);				    	 
	Show_Str(30,90,200,16,"正点原子@ALIENTEK",16,0);				    	 
	Show_Str(30,110,200,16,"2015年4月30日",16,0);
	Show_Str(30,130,200,16,"KEY0:REC/PAUSE",16,0);
	Show_Str(30,150,200,16,"KEY1:STOP&SAVE",16,0); 
	Show_Str(30,170,200,16,"KEY_UP:Play The File",16,0);
	while(1)
	{
 		LED1=0; 	  
