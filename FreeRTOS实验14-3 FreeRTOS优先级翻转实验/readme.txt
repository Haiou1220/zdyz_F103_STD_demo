...
实验现象:
	实验中有三个应用任务：high_task，middle_task和low_task。任务
	high_task和low_task使用同一个二值信号量BinarySemaphore。在这
	个过程中如果信号量长时间被low_task占用的话就会导致优先级翻转
	的发生。
	
注意事项:
	无. 

参考资料：STM32F103 FreeRTOS开发手册.pdf 第十四章
